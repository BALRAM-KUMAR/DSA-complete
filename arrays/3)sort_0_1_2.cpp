...
Approach: 
1) take three varialbe count_zero,count_one,and count_two
2) count tha all values of 0,1,2
3) now 0 value assigning zero time , 1- count_one time and 2-count two_times
